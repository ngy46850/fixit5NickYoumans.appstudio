...
const cacheName = 'fixit5NickYoumans-2020-10-23 09:46:10.002825'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'fixit5NickYoumans'.length) === 'fixit5NickYoumans') {
